...
export default function HomePage() {
  return (
    <PageLayout>
      <PageHero
        eyebrow="브라우저 로컬 처리"
        title="업로드 전 이미지 압축, 리사이즈, 포맷 변환, EXIF 제거를 한 곳에서"
      >
        <p>
          블로그 발행, 쇼핑몰 업로드, 커뮤니티 첨부 전에 사진과 캡처를 압축,
          크기 조절, 형식 변환, EXIF 제거까지 한 흐름에서 처리할 수
          있습니다. 파일은 서버 업로드 없이 현재 브라우저 안에서만 다룹니다.
        </p>
        <p>
