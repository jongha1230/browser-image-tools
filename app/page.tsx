...
export default function HomePage() {
  return (
    <PageLayout>
      <PageHero
        eyebrow="브라우저 로컬 이미지 도구"
        title="올리기 전에 끝내는 이미지 정리"
      >
        <p>
          사진과 캡처를 올리기 전에 용량 줄이기, 크기 맞추기, 형식 바꾸기,
          EXIF 정리를 한 곳에서 처리할 수 있습니다. 파일은 서버에 올리지 않고
          현재 브라우저 안에서만 다룹니다.
        </p>
        <p>
          회원가입 없이 여러 장을 한 번에 넣고, 필요한 결과만 개별 저장하거나
          ZIP으로 내려받으면 됩니다.
        </p>
      ...
      <PageSection
        ...
        intro={
          <p>
            자주 하는 작업만 먼저 모았습니다. 각 페이지는 설명 본문과 실제 작업
            패널을 함께 제공해 처음 들어와도 바로 시작할 수 있습니다.
          </p>
        }
      >
      ...
      <PageSection
        ...
        intro={
          <p>
            무거운 편집기 대신, 업로드 전에 필요한 정리 작업에만 집중했습니다.
          </p>
        }
      >
