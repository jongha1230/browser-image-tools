...
export default function GuidesPage() {
  ...
  return (
    <PageLayout breadcrumbs={[{ href: "/", label: "홈" }, { label: "가이드" }]}>
      <PageHero eyebrow="실전 가이드" title="블로그 업로드 전 점검과 상품 이미지 준비 가이드">
        <p>
          압축 세기, 형식 선택, 작업 순서, 배치 전 점검처럼 실제 업로드 직전에
          막히는 지점을 한국어로 정리했습니다. 블로그 본문, 썸네일, 상품 이미지
          준비 흐름에 바로 이어질 수 있는 문서만 모았습니다.
        </p>
      ...
      <PageSection
        ...
        intro={
          <p>
            블로그 업로드 전 점검, 상품 리스트용 썸네일 준비, 상세 캡처 정리,
            여러 장 한 번에 정리 같은 실제 공개 업로드 동선에 가까운 문서를 먼저
            묶었습니다.
          </p>
        }
      >
      ...
      <PageSection
        ...
        intro={
          <p>
            블로그 대표 이미지, 상품 썸네일 기준, 반복 저장 화질 저하, PNG 선택
            실수처럼 업로드 전에 자주 다시 찾는 문서를 함께 볼 수 있습니다.
          </p>
        }
      >
        <div className="card-grid">
      ...
      <PageSection
        ...
        intro={
          <p>
            리사이즈 순서, 투명 배경 변환, 브라우저 로컬 처리 한계처럼 작업
            기준을 먼저 잡아 주는 문서도 별도로 모아 두었습니다.
          </p>
        }
      >
        <div className="card-grid">
      ...
      <PageSection
        ...
        intro={
          <p>
            읽고 끝내기보다 바로 업로드 전 이미지 정리로 이어질 수 있게 관련
            도구를 함께 연결했습니다.
          </p>
        }
      >
