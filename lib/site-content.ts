...
export const toolRoutes = [
  ...
  },
  {
    ...
    highlights: [
      "가로, 세로, 긴 변 기준 입력을 모두 받을 수 있는 UI를 위한 자리입니다.",
      "비율 잠금과 대표 프리셋이 함께 보이도록 안내 문구를 렌더링합니다.",
      "배치 리사이즈와 내보내기 형식 선택을 이후 확장 포인트로 둡니다.",
    ],
    checklist: [
      "비율 유지 또는 직접 입력 선택",
      "대표 프리셋 제공 준비",
  ...
  },
  {
    ...
    highlights: [
      ...
      "투명 배경 처리와 저장 옵션 차이를 한국어 설명으로 먼저 제공합니다.",
      "일괄 포맷 변환과 다운로드 묶음 구성을 이후 단계에서 연결할 수 있습니다.",
    ],
    checklist: [
      "변환 전후 포맷 특징 설명",
      "투명도 유지 가능 여부 노출",
