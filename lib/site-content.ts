...
export const siteTagline = "한국어 중심, 광고 기반, 브라우저 내 로컬 이미지 유틸리티";
export const siteDescription =
  "이미지 압축, 크기 조절, 포맷 변환, EXIF 제거와 배치 내보내기를 모두 브라우저 안에서 처리하는 한국어 중심 이미지 유틸리티 사이트입니다.";
...
export const toolRoutes = [
  {
    ...
    metadataDescription:
      "브라우저에서 JPG, PNG, WebP 이미지 용량을 로컬로 줄이고 성공 파일을 ZIP으로 저장하는 이미지 압축 도구 안내 페이지입니다.",
    intro:
      "블로그, 커뮤니티, 쇼핑몰 업로드 전에 JPG, PNG, WebP 파일 크기를 여러 장 한 번에 낮추는 흐름을 염두에 둔 페이지입니다.",
    highlights: [
      "품질 조절, 예상 용량 비교, 원본 유지 흐름을 한 번의 배치 실행으로 묶습니다.",
      "파일은 서버로 전송하지 않고 브라우저 탭 안에서만 처리합니다.",
      "성공한 결과만 ZIP으로 다시 묶어 일괄 다운로드할 수 있습니다.",
    ],
    checklist: [
      "목표 용량 또는 품질 범위 선택",
      "원본 대비 파일별 성공/실패와 다운로드 크기 비교",
      "여러 파일 일괄 ZIP 내보내기",
    ],
  ...
  },
  {
    ...
    metadataDescription:
      "브라우저에서 JPG, PNG, WebP 이미지 크기를 로컬로 조정하고 결과를 ZIP으로 다운로드하는 리사이즈 도구 페이지입니다.",
    intro:
      "가로와 세로 입력, 비율 잠금, 자주 쓰는 크기 프리셋을 이용해 여러 이미지의 해상도를 한 번에 조절할 수 있습니다.",
    highlights: [
  ...
  },
  {
    ...
    metadataDescription:
      "브라우저에서 JPG, PNG, WebP 사이를 로컬로 변환하고 결과 정보를 ZIP과 함께 확인하는 포맷 변환 도구 페이지입니다.",
    intro:
      "JPEG, PNG, WebP 가운데 다른 형식으로 여러 장을 한 번에 변환하면서 품질, 파일 크기, 저장 파일명을 바로 확인할 수 있습니다.",
    highlights: [
  ...
  },
  {
    ...
    metadataDescription:
      "브라우저에서 사진 EXIF 메타데이터를 로컬로 제거하고 성공 파일을 ZIP으로 내보내는 개인정보 보호 도구 안내 페이지입니다.",
    intro:
    ...
    highlights: [
      ...
      "배치 제거 후 성공 파일만 ZIP으로 일괄 저장할 수 있습니다.",
    ],
    checklist: [
      "EXIF 포함 가능 정보 안내",
      "제거 후 공유 전 확인 포인트 정리",
