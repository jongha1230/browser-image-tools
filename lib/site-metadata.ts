...
export const pageMetadataCatalog: Record<SitePath, PageMetadataEntry> = {
  "/": {
    title: "블로그·썸네일·상품 이미지 준비를 위한 업로드 전 이미지 정리",
    description:
      "블로그 업로드 전 점검, 썸네일·상품 이미지 준비를 위해 이미지 압축, 리사이즈, 포맷 변환, EXIF 제거를 브라우저에서 처리하고 여러 장 결과를 저장하는 로컬 이미지 도구입니다.",
  },
  "/tools": {
    title: "업로드 전 이미지 정리 도구 모음",
    description:
      "블로그 업로드 전 점검, 썸네일·상품 이미지 준비, 공유 전 EXIF 정리에 맞는 도구를 바로 열고 브라우저 안에서 처리할 수 있는 도구 허브입니다.",
  },
  "/guides": {
    title: "블로그 업로드 전 점검·상품 이미지 준비 가이드",
    description:
      "블로그 업로드 전 점검, 썸네일·상품 이미지 준비, 압축 기준, 리사이즈 순서, 포맷 선택, EXIF 제거를 정리한 실전 가이드 허브입니다.",
  },
  "/about": {
    title: "브라우저 이미지 툴 소개",
    description:
